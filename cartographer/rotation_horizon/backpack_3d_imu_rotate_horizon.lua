...
--TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.pose_rotation_weight = 0.1
--TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.odometry_translation_weight = 0.1
--TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.pose_translation_weight = 0.1
--TRAJECTORY_BUILDER_3D.motion_filter.max_time_seconds = 20
...
--TRAJECTORY_BUILDER_3D.imu_gravity_time_constant = 30
